...
const Hero = () => {
    ...
    return (
        <header className="min-h-[100svh] hero-background text-white relative">
            ...
            <nav className="absolute right-10 bottom-10 flex flex-row gap-3">
                <a href={Github} target='_blank'>
                    <div className="h-14 w-14 rounded-full border-[1px] flex justify-center items-center border-dashed">
